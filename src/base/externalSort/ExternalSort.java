...
public class ExternalSort {
    ...
    public static void sort(String f1, String f2) throws Exception {
        ...
        while (size <= fileByteSize) {
            if (writeToOriginal) {
                raf1.seek(0);
                dos = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(raf1.getFD())));
            } else {
                raf2.seek(0);
                dos = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(raf2.getFD())));
                }
    ...
    public static void externalSort(String f1, String f2, int size) throws Exception{
        ...
        DataInputStream dis = new DataInputStream(new BufferedInputStream(new FileInputStream(raf1.getFD())));
        DataOutputStream dos = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(raf2.getFD())));
    ...
    public static DataOutputStream merge(String file, DataOutputStream dos, int start, int size) throws IOException {
        ...
        DataInputStream dis3 = new DataInputStream(new BufferedInputStream(new FileInputStream(raf2.getFD())));
